...
export { default as MovieHeader } from './MovieHeader/Header'
...
export { default as MovieDetails } from './MovieDetail/Detail'
export { default as MovieChars } from './Movie-characters/MovieChars'
